...
export class createDB1627654184216 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "professors_disciplines_disciplines" ("professorsId" integer NOT NULL, "disciplinesId" integer NOT NULL, CONSTRAINT "PK_0e5f7769559591a837908b11875" PRIMARY KEY ("professorsId", "disciplinesId"))`);
